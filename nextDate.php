<!DOCTYPE html>
<html lang="en"><head><title>Next Date</title></head><body>
    <?php
        ...
        #365 days
            ...
            echo  __LINE__ . ' -> '; if($arr[2] % 400 == 0 ) {
                #month 2
                echo  __LINE__ . ' -> '; if($arr[1] == 2){
                    echo  __LINE__ . ' -> '; if($arr[0] > 29){
                        echo  __LINE__; echo '<script>alert("Please check your date and try again.");
                        window.location.href = "index.html";
                        </script>';
                    }
                    else if($arr[0] == 29){                                                         echo  __LINE__ . ' -> ';
                        echo  __LINE__ . ' -> '; $arr[0] = 01;
                        echo  __LINE__ . ' -> '; $arr[1] = $arr[1] + 1;
                        echo  __LINE__ . ' -> '; if($arr[1]>12){
                            echo  __LINE__ . ' -> '; $arr[2] = $arr[2]+1;
                        }
                    }
                    else{                                                                           echo  __LINE__ . ' -> ';
                        echo  __LINE__ . ' -> '; $arr[0] = $arr[0]+1;
                    }
                    echo  __LINE__ . '<br>'; echo $arr[0]."/".$arr[1]."/".$arr[2];
                }
                #month 4 6 9 11
                else if($arr[1] == 4 or $arr[1] == 6 or $arr[1] == 9 or $arr[1] == 11){             echo  __LINE__ . ' -> ';
                    echo  __LINE__ . ' -> '; if($arr[0] > 30){
                        echo  __LINE__; echo '<script>alert("Please check your date and try again.");
                        window.location.href = "index.html";
                        </script>';
                    }
